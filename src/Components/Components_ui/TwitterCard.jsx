...
const TwitterPost = ({imagePerfil, imagePost}) => {
  ...
  <>
     <div className=" grid grid-col-2 container mx-auto p-4 w-full h-min border-2 border-solid border-gray-700">
      ...
      <button className='hover:shadow-lg hover:bg-red-500'>
      ...
      <span>
        ...
        <span className='text-gray-100'>1.9k</span>
      </span>
      ...
      <span>
        ...
        <span className='text-gray-100'>7.7k</span>
      </span>
      ...
      <span>  
        ...
        <span className='text-gray-100'>190k</span>
      </span>
