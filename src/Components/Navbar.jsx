  ...
  <div className="fixed top-0 w-full dark:bg-gray-900 max-w-screen-xl flex flex-wrap items-center sm:justify-around justify-between mx-auto p-4">
    ...
    <div className="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        ...
        <Enlace link={'#home'}>Home</Enlace>
        <Enlace link={'#about'}>About</Enlace>
        <Enlace link={'#skills'}>Skills</Enlace>
        <Enlace link={'#projects'}>Projects</Enlace>
        <Enlace link={'#contact'}>Contact</Enlace>
      </ul>
    </div>
  </div>
</nav>
