...
export default function ProjectCardHover({ title, description, onMouseLeave }) {
  return (
    <a href="https://rickandmortydtg.netlify.app/" key={title} className="mt-4 sm:w-1/4 rounded overflow-hidden shadow-lg bg-home inline-block mr-8 p-8 h-4/5" onMouseLeave={onMouseLeave}>
